...
<body style="background-image:url(dangers-to-avoid-during-night-camping.jpg)">
						...
						<div class="submemu1">
							<ul>
								<li class="hover-me"><a href="#">Equipement</a>
									...
									<li><a href="book/boooks.php">Livres</a> </li>
								</ul>
							</div>
						</li>
					</li>
					<ul>
						<li><a href="reservation/form.php"><i class="fa fa-book"></i>RESERVATION</a></li>
						<li><a href="CONSEIL/CONSEIL.php"><i class="fa fa-heart"></i>CONSEILS</a>

						</li>

     <?php  if (isset($_SESSION['id']) ) :?>

      <li ><a href="../DB/deconnexion.php"><i class="fa fa-sign-in"></i>DECONNEXION</a></li>


      <?php  else: ?>

        <li><a href="../SUBSCRIBE/connexion.php"><i class="fa fa-sign-in"></i>CONNEXION</a></li>
  ...
  <br><br><br><br>
  <div class="">
    <h1 class="h112" style="text-align:center">Les vallées du Maroc</h1>
    ...
    <div class="main12">
      ...
      <div style="background-color: aliceblue"class="card12">
        ...
        <div class="image12">
         <img class="photox" src="vallee/paradise-valley.jpg">
       </div>
       <div class="title12">
         <h2>
         Paradise Vallée</h2>
       ...
       <div class="des12">
         <p>Paradise Valley est le nom donné à une partie de la vallée de la rivière Tamraght, dans les montagnes du Haut Atlas marocain. Elle est située à environ 20 km au nord d'Agadir. </p>
     ...
     <div style="background-color: aliceblue"class="card12">
      ...
      <div class="image12">
       <img class="photox" src="vallee/ouad laou.PNG">
     </div>
     <div class="title12">
       <h2>
       Ouad Laou Vallée</h2>
     ...
     <div class="des12">
      <p>Ouad Laou est une station balnéaire du Maroc. Elle est située dans la région de Tanger-Tétouan-Al Hoceïma, à 44 km de Tétouan. <br>.</p>
      <button>Savoir plus...</button>
    </div>
  </div>
  ...
  <div style="background-color: aliceblue"class="card12">
    ...
    <div class="image12">
     <img class="photox" src="vallee/marshika.PNG">
   </div>
   <div class="title12">
     <h2>
     Mar Chica Vallée </h2>
   ...
   <div class="des12">
     <p>La Lagune de Nador est une lagune de la côte méditerranéenne du Maroc, au Rif, située à proximité des agglomérations de Nador et de Melilla <br>. </p>
     <button>Savoir plus...</button>
   </div>
 </div>
 ...
 <div style="background-color: aliceblue"class="card12">
  ...
  <div class="image12">
   <img class="photox" src="vallee/tamda.PNG">
 </div>
 <div class="title12">
   <h2>
   Tamda vallée</h2>
 ...
 <div class="des12">
   <p>La lac de Tamda est le plus haut au maroc , Il se situe a 65 Km au nord de la ville D'Ouarzazate <br><br>.</p>
   <button>Savoir plus...</button>
 </div>
</div>
...
<div style="background-color: aliceblue"class="card12">
  ...
  <div class="image12">
   <img class="photox" src="vallee/lac fini.PNG">
 </div>
 <div class="title12">
   <h2>
   Ifni Vallée</h2>
 ...
 <div class="des12">
   <p>Le lac d'Ifni est un lac de montagne, probablement de type volcanique, située dans le Parc national de Toubkal à une altitude de 2 295 m. Situé à 70 km au sud de Marrakech,<br>.</p>
   <button>Savoir plus...</button>
 </div>
</div>
<div style="background-color: aliceblue"class="card12">
  ...
  <div class="image12">
   <img class="photox" src="vallee/ouad farda.PNG">
 </div>
 <div class="title12">
   <h2>
   Ouad ferda Vallée</h2>
 </div>
 <div class="des12">
  <p>'Oued Farda, qui a érodé le rocher jusqu'à former cette oeuvre d'art naturelle. Il sert de pont entre les deux bords de la gorge pour les habitants et les excursionnistes.<br><br><br>
  </p>
  <button>Savoir plus...</button>
</div>
</div>
<div style="background-color: aliceblue"class="card12">
  ...
  <div class="image12">
   <img class="photox" src="vallee/tiqndiline.PNG">
 </div>
 <div class="title12">
   <h2>
   Tislit Vallée</h2>
 ...
 <div class="des12">
  <p>Le lac Tislit est un lac d'altitude du Haut Atlas central situé dans le cercle (commune) d'Imilchil. Il s'agit d'un agdal (pâturage réservé) où les tribus Aït Haddidou conduisent leurs troupeaux l'été</p><br>
  <button>Savoir plus...</button>
</div>
</div>
</div>
